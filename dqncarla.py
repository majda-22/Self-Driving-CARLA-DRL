"""
This module contains the implementation of the Deep Q-Learning network for the CARLA simulator.
"""
...
def main():
    ...
    argparser.add_argument(
        '--host',
        metavar='H',
        default='localhost',#127.0.0.1 It was this before changing
        help='IP of the host server (default: localhost)')#also here
    argparser.add_argument(
        '-p', '--port',
        metavar='P',
        default=5000,
